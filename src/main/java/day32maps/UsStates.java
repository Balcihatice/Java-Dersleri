...
public enum UsStates {
    ...
    public static String getStateNameFromAbbreviation(String abbreviation) {
        ...
        return Arrays.
                stream(values()).
                filter(UsStates -> UsStates.getAbbrevation().equals(abbreviation)).
                findFirst().
                get().
                getStateName();
    ...
    public static String getAbbreviationFromCapital(String capital) {
        ...
        return Arrays.
                stream(values()).
                filter(t -> t.getCapital().equals(capital)).findFirst().get().getStateName();

    }

    //Example 1 :Baskenti verilen state`in kisaltmasini ekrana yazdiran methodu olusturunuz

    public static String getAbbreviationsCapital(String capital) {
