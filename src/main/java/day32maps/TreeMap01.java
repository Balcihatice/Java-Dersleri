...
public class TreeMap01 {
    ...
    public static void main(String[] args) {
        ...
        //alfabetik siradaki key`den baslayarak sona kadar tum entry`leri bize verir.

        NavigableMap<String, Double> map2 = salaries.tailMap("Kevin Bridgeman", false);
        System.out.println(map2);//{Mary Star=1000.0, Tom Hanks=3000.0} kevin haric aldik
        //alfabetik siradaki key`den baslayarak sona kadar tum entry`leri bize verir.Bizim verdigimiz
        // false sectigimiz icin key`i haric tutar
